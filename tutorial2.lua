...
local function gotoMenu()
  ...
  if(liberarToutch)then
   composer.gotoScene( "menu", { time=1200, effect="slideRight" } )
  end
...
text2 = display.newImageRect( "Sprites/Tutorial_Text_2.png", 340, 570 ) -- carrega a imagem de fundo da tela
text2.x = display.contentCenterX
text2.y = display.contentCenterY 
